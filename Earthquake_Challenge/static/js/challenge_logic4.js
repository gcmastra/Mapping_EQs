...
// Deliverable 3 - a nighttime map layer and a Major Eartquake layer have been added
console.log("night time layer and major EQ layer added");
...
// d3.json().then(function(data) {
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data2) {
    ...
    console.log("working data 2 time = " + timestamp2);
    console.log(data2);
    ...
    // boulder colors from a palette on W3 schools to distinguis the Major EQs if both layers are selected
    function getColor(magnitude) {
    if (magnitude > 6) {
      return "#6b5b95";
    }    
...
function getRadius(magnitude) {
  ...
  // make major EQs slighly larger and bolder color than the regular EQs
  return 1 + magnitude * 5;
}
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  fileURL = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
  ...
  console.log("working tectonic 2 time = " + timestamp);
  // add a time stamp to the console log to see what happens first
  // as you can see in the console, time 2 happens before time 1 
